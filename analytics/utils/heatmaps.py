...
class HeatMapAnalyzer:
    ...
    def visualize(self, title: str = "Heat Map", save_path: str = None, show: bool = True):
        ...
        field = plt.imread(f'{cdir}/field.png')
        plt.imshow(field, extent=[0, self.field_length, 0, self.field_width], alpha=1)

        heat_map = self.get_normalized_heat_map()
        plt.imshow(heat_map.T, origin='lower', cmap='Reds', alpha=0.5,
